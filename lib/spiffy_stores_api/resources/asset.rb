module SpiffyStoresAPI
  ...
  #   asset = SpiffyStoresAPI::Asset.new(:key => 'assets/special.css', :theme_id => 12345)
  #
  # Find by key:
  #   asset = SpiffyStoresAPI::Asset.find('assets/image.png', :params => {:theme_id => 12345})
  #
  ...
  #
  #   * set a URL from which SpiffyStores will fetch the value:
  ...
  class Asset < Base
    ...
    #   SpiffyStoresAPI::Asset.find('layout/theme.liquid', :params => {:theme_id => 99})
    def self.find(*args)
      if args[0].is_a?(Symbol)
        ...
        path_prefix = params[:theme_id] ? "/admin/themes/#{params[:theme_id]}" : "/api"
    ...
    # For text assets, SpiffyStores returns the data in the 'value' attribute.
