...
class OrderRiskTest < Test::Unit::TestCase
  def test_create_order_risk
    ...
    v = SpiffyStoresAPI::OrderRisk.new(:order_id => 450789469)
  ...
  def test_get_order_risks
    ...
    v = SpiffyStoresAPI::OrderRisk.find(:all, :params => {:order_id => 450789469})
  ...
  def test_get_order_risk
    ...
    v = SpiffyStoresAPI::OrderRisk.find(284138680, :params => {:order_id => 450789469})
    assert_equal 284138680, v.id
  end
