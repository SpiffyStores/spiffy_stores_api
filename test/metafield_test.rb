...
class MetafieldTest < Test::Unit::TestCase
  ...
  def test_create_metafield_for_a_blog
    ...
    blog = SpiffyStoresAPI::Blog.find(1008414260)
    metafield = blog.add_metafield(SpiffyStoresAPI::Metafield.new(:namespace => "summaries", :key => "First Summary", :value => "Make commerce better", :value_type => "string"))
  ...
  def test_update_metafield
    ...
    metafield = SpiffyStoresAPI::Metafield.find(721389482)
