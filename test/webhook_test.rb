...
class WebhookTest < Test::Unit::TestCase
  test 'create should create a webhook' do
    ...
    webhook = SpiffyStoresAPI::Webhook.create(address: "http://www.yoloship.it/webhook", topic: "orders/create", format: "json")
