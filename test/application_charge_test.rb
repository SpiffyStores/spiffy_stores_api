...
class ApplicationChargeTest < Test::Unit::TestCase
  ...
  def test_application_charge_create
    ...
    charge = SpiffyStoresAPI::ApplicationCharge.create(
        name: "iPod Cleaning",
        price: 5.00,
        return_url: "http://google.com"
    )

    assert_equal 'https://this-is-my-test-shop.spiffystores.com/api/charges/803742/confirm_application_charge?signature=BAhpA55DDA%3D%3D--55b44e274e438c619be4631c804abcbcb6ee915a', charge.confirmation_url
  end
  ...
  def test_get_application_charge
    ...
    charge = SpiffyStoresAPI::ApplicationCharge.find(803742)
  ...
  def test_list_application_charges
    ...
    charges = SpiffyStoresAPI::ApplicationCharge.find(:all)
  ...
  def test_list_pending_application_charges
    ...
    pending_charges = SpiffyStoresAPI::ApplicationCharge.pending
  ...
  def test_list_expired_application_charges
    ...
    expired_charges = SpiffyStoresAPI::ApplicationCharge.expired
  ...
  def test_list_accepted_application_charges
    ...
    accepted_charges = SpiffyStoresAPI::ApplicationCharge.accepted
  ...
  def test_list_declined_application_charges
    ...
    declined_charges = SpiffyStoresAPI::ApplicationCharge.declined
  ...
  def test_activate_application_charge
    ...
    charge = SpiffyStoresAPI::ApplicationCharge.accepted
