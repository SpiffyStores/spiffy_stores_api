...
class DiscountTest < Test::Unit::TestCase
  test 'get should get a discount' do
    ...
    discount = SpiffyStoresAPI::Discount.find(680866)
  ...
  test 'get should get all discounts' do
    ...
    discounts = SpiffyStoresAPI::Discount.all
  ...
  test 'create should create a discount' do
    ...
    discount = SpiffyStoresAPI::Discount.create(code: 'TENOFF', discount_type: 'percentage')
