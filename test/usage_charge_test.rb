...
class UsageChargeTest < Test::Unit::TestCase
  ...
  def test_create_usage_charges
    ...
    usage_charge = SpiffyStoresAPI::UsageCharge.new(description: '1000 emails', price: 1.0)
  ...
  def test_get_usage_charges
    ...
    usage_charge = SpiffyStoresAPI::UsageCharge.find(359376002, params: {recurring_application_charge_id: 654381177})
