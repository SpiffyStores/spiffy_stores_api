...
class AssetTest < Test::Unit::TestCase
  def test_get_assetss
    ...
    v = SpiffyStoresAPI::Asset.find(:all, :params => {:theme_id => 1})
  end
...
#   v = SpiffyStoresAPI::Asset.find('templates/index.liquid', :params => {:theme_id => 1})
# end

  def test_get_asset
    fake "assets.json?asset%5Bkey%5D=templates%2Findex.liquid", :extension=> false, :method => :get, :body => load_fixture('asset')
    v = SpiffyStoresAPI::Asset.find('templates/index.liquid')
  end
end
