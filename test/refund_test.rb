...
class RefundTest < Test::Unit::TestCase
  ...
  test '#create should create a refund' do
    ...
    refund = SpiffyStoresAPI::Refund.create(
      :order_id => 450789469,
      :restock => true,
      :note => "wrong size",
  ...
  test '#find should return a refund' do
    ...
    refund = SpiffyStoresAPI::Refund.find(509562969, :params => {:order_id => 450789469})
  ...
  test '#calculate a refund' do
    ...
    refund = SpiffyStoresAPI::Refund.calculate(data, :params => {:order_id => 450789469})
