...
class RecurringApplicationChargeTest < Test::Unit::TestCase
  ...
  def test_recurring_application_charges_create
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.create(
      name: "Default Plan",
      price: 10.0,
      return_url: "http://test.com/confirm"
    )

    assert_equal 'http://apple.spiffystores.com/api/charges/654381177/confirm_recurring_application_charge?signature=BAhpBHkQASc%3D--419fc7424f8c290ac2b21b9004ed223e35b52164', charge.confirmation_url
  end
  ...
  def test_get_recurring_application_charges
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.find(654381177)
  ...
  def test_list_recurring_application_charges
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.find(:all)
  ...
  def test_list_since_recurring_application_charges
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.find(:all, params: { since_id: '64512345' })
  ...
  def test_list_fields_recurring_application_charges
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.find(:all, params: { fields: 'name' })
  ...
  def test_pending_recurring_application_charge
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.pending
  ...
  def test_cancelled_recurring_application_charge
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.cancelled
  ...
  def test_accepted_recurring_application_charge
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.accepted
  ...
  def test_declined_recurring_application_charge
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.declined
  ...
  def test_cancel_recurring_application_charge
    ...
    charge = SpiffyStoresAPI::RecurringApplicationCharge.current
  ...
  def test_no_recurring_application_charge_found
    ...
    assert_equal 0, SpiffyStoresAPI::RecurringApplicationCharge.all.count
    assert_equal nil, SpiffyStoresAPI::RecurringApplicationCharge.current
    assert_equal [], SpiffyStoresAPI::RecurringApplicationCharge.pending
  end

  def test_recurring_application_charge_not_found_error
    fake "recurring_application_charges", body: '{"errors":"Not Found"}', status: 404

    all_application_charges = SpiffyStoresAPI::RecurringApplicationCharge.all
